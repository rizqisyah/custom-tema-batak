...
const [port = '5179', selector = '.divider__and', cx = '40', cy = '1930', cw = '320', ch = '200'] =
  process.argv.slice(2)
const OUT = '.figma-tmp'

const browser = await chromium.launch()
// The design frame's own width. Measuring at any other viewport scales every number
// this returns by viewport/FRAME_W, and it then reads as a placement error.
