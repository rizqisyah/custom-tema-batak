...
match the asset against the frame render instead.
    ...
    python3 scripts/locate.py src/assets/<band>/parts/<id>.webp 217 1016
...
# scale 1, so 1px == 1 design px. Set per frame:
# LOCATE_REF=.figma-tmp/exports<N>/frame<N>-full.png
REF = os.environ.get("LOCATE_REF") or sys.exit("set LOCATE_REF=<1x frame render png>")
