...
REF = os.environ.get('BAND_REF') or sys.exit('set BAND_REF=<1x body frame render png>')  # scale 1, so 1px == 1 design px
...
FRAME_W = int(os.environ.get('FRAME_W', '0'))  # the DESIGN frame's width, per template
if not FRAME_W:
